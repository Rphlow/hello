    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        expandableListView.setOnChildClickListener { parent, v, groupPosition, childPosition, id ->
            ...
            val intent = if ((groupPosition == 0) && (childPosition == 0)) {
                startActivity(Intent(this@region4B, City_Batanes::class.java))
            } else if ((groupPosition == 0) && (childPosition == 1)) {
                startActivity(Intent(this@region4B, Municipalities_Batanes::class.java))
            } else if ((groupPosition == 1) && (childPosition == 0)) {
                startActivity(Intent(this@region4B, City_Cagayan::class.java))
            } else if ((groupPosition == 1) && (childPosition == 1)) {
                startActivity(Intent(this@region4B, Municipalities_Cagayan::class.java))
            } else if ((groupPosition == 2) && (childPosition == 0)) {
                startActivity(Intent(this@region4B, City_NuevaVizcaya::class.java))
            } else if ((groupPosition == 2) && (childPosition == 1)) {
                startActivity(Intent(this@region4B, Municipalities_NuevaVizcaya::class.java))
            } else if ((groupPosition == 3) && (childPosition == 0)) {
                startActivity(Intent(this@region4B, City_Quirino::class.java))
            } else if ((groupPosition == 3) && (childPosition == 1)) {
                startActivity(Intent(this@region4B, Municipalities_Quirino::class.java))
            } else {
